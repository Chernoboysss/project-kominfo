    ...
    <div class="container">
                        ...
                        <div class="carousel-inner">
                                ...
                                <div class="text-center">
                                    <div class="d-grid gap-2 col-4 mx-auto mt-5 ">
                                        ...
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                            data-bs-target="#modal1">INFORMASI TYPE 1</button>
                                    </div>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="radio" class="btn-check" name="type" id="option1"
                                                        value="type1">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="d-grid gap-2 col-4 mx-auto mt-5 ">
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                            data-bs-target="#modal2">INFORMASI TYPE 2</button>
                                    </div>
                                    <!-- Modal -->
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="d-grid gap-2 col-4 mx-auto mt-5 ">
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                            data-bs-target="#modal3">INFORMASI TYPE 3</button>
                                    </div>
                                </div>
                                <!-- Modal -->
        ...
        <table class="table table-warning table-hover text-center mt-5">
           ...
           $jamSekarang = date("G");
            function waktu($jam,$durasi){
                ...
                if ($jam + $durasi == $jamSekarang || $jam + $durasi <= $jamSekarang || $jamSekarang- ($jam - $durasi) <= 0){
        ...
        // <!-- function untuk mengeluarkan gambar -->
            ...
            if (isset($_POST['submit'])){
                ...
                $data = [$nama,$jam,$tipe,$harga,$jamSekarang];
                ...
                for($i=0; $i<count($datasewa); $i++){
                    ...
                    echo "<td>".$datasewa[$i][1]." jam</td>";
                    echo "<td>".$datasewa[$i][3]."</td>";
                    echo "<td>".$datasewa[$i][4]." : 00 WIB</td>";
                    echo "<td>".waktu($datasewa[$i][4],$datasewa[$i][1])."</td>";
                    ?>
                    <form action='delete.php' method='post'>
                    <?php
                    echo "<td><button type='' class='btn btn-success' value =$nama name='delete' data-bs-toggle='modal' data-bs-target='#exampleModal'>delete</button></td>";
                    echo "</tr>";
                    echo "</form>";
                }
                echo "<tr>";
                echo "<td colspan='8'><h4>Total unit yang di pinjam ". count($datasewa)."</h4></td>";
                echo "</tr>";
